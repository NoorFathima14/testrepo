...
localtime = datetime.now().strftime("%A, %B %d, %Y")

lblinfo = Label(Tops, font = ('Lucida Sans Unicode', 30, 'bold'), text = "Restaurant Management System", fg = "#4DAEB7", bd = 10, anchor = 'center')
lblinfo.grid(row = 0, column = 0)
lblinfo = Label(Tops, font = ('Palatino Linotype', 20), text = localtime, fg = "steel blue", anchor = 'center')
...
def Orders():
    ...
    t =[]
    for i in [cof, colfries, cob, cofi, cochee, codr]:
        if i == "":
            i = "0"
        t.append(float(i))
    cof, colfries, cob, cofi, cochee, codr = tuple(t)
    ...
    costofmeal = chr(8377), str('%.2f'% (costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks))
    ...
    Service = chr(8377), str('%.2f'% Ser_Charge)
    OverAllCost = chr(8377), str('%.2f'% (PayTax + Totalcost + Ser_Charge))
    PaidTax = chr(8377), str('%.2f'% PayTax)
    ...
    sql1 = "INSERT INTO REPORTS VALUES (%s, %s)"
    sql2 = (str(randomRef), chr(8377) + OverAllCost[1])
    sql.execute(sql1, sql2)
    RMS.commit()
...
txtdisplay = Entry(f2, font = ('ariel', 20, 'bold'), textvariable = text_Input, bd = 5, insertwidth = 7, bg = "white", justify = 'right', state = 'disabled')
...
txtcost = Entry(f1, font =('ariel',16, 'bold'), textvariable = cost, bd = 6, insertwidth = 4, bg = "powder blue", justify = 'right', state = 'disabled')
txtcost.grid(row = 1, column = 3)

lblService_Charge = Label(f1, font =( 'aria',16, 'bold' ), text = "Service Charge", fg = "steel blue", bd = 10, anchor = 'w')
lblService_Charge.grid(row = 2, column = 2)
txtService_Charge = Entry(f1, font =('ariel',16, 'bold'), textvariable = Service_Charge, bd = 6, insertwidth = 4, bg = "powder blue", justify = 'right', state = 'disabled')
txtService_Charge.grid(row = 2, column = 3)

lblTax = Label(f1, font =( 'aria',16, 'bold' ), text = "Tax", fg = "steel blue", bd = 10, anchor = 'w')
lblTax.grid(row = 3, column = 2)
txtTax = Entry(f1, font =('ariel',16, 'bold'), textvariable = Tax, bd = 6, insertwidth = 4, bg = "powder blue", justify = 'right', state = 'disabled')
txtTax.grid(row = 3, column = 3)

lblSubtotal = Label(f1, font =( 'aria',16, 'bold' ), text = "Subtotal", fg = "steel blue", bd = 10, anchor = 'w')
lblSubtotal.grid(row = 4, column = 2)
txtSubtotal = Entry(f1, font =('ariel',16, 'bold'), textvariable = Subtotal, bd = 6, insertwidth = 4, bg = "powder blue", justify = 'right', state = 'disabled')
txtSubtotal.grid(row = 4, column = 3)

lblTotal = Label(f1, font =( 'aria',16, 'bold' ), text = "Total", fg = "steel blue", bd = 10, anchor = 'w')
lblTotal.grid(row = 5, column = 2)
txtTotal = Entry(f1, font =('ariel',16, 'bold'), textvariable = Total, bd = 6, insertwidth = 4, bg = "powder blue", justify = 'right', state = 'disabled')
...
btnTotal = Button(f1, padx = 16, pady = 8, bd = 10, fg = "black", font =('ariel',16, 'bold'), width = 10, text = "TOTAL", bg = "powder blue", command = Orders)
...
def price():
    roo = Tk()
    roo.geometry("400x300")
    roo.title("Price List")
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "ITEM", fg = "black", bd = 5)
    lblinfo.grid(row = 0, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "_____________", fg = "white", anchor = W)
    lblinfo.grid(row = 0, column = 2)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "PRICE", fg = "black", anchor = W)
    lblinfo.grid(row = 0, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Fries Meal", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 1, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "25", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 1, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Lunch Meal", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 2, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "40", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 2, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Burger Meal", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 3, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "35", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 3, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Pizza Meal", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 4, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "50", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 4, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Cheese Burger", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 5, column = 0)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "30", fg = "steel blue", anchor = W)
    lblinfo.grid(row = 5, column = 3)
    lblinfo = Label(roo, font =('aria', 18, 'bold'), text = "Drinks", fg = "steel blue", anchor = W)
...
#MySQL-----
RMS = mysql.connector.connect(host = "localhost", user = "root", passwd = "asiya@14")
sql = RMS.cursor()
sql.execute("CREATE DATABASE IF NOT EXISTS RMS;")
sql.execute("USE RMS;")
sql.execute("CREATE TABLE IF NOT EXISTS REPORTS(Order_no char(5), Price varchar(255))")
